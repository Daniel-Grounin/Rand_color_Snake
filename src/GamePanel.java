...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public void startGame(){
        newApple(); //call new apple method to create new apple on the screen
        running = true;
    ...
    public void checkCollision(){
        //checks if head collides with any other part of the body
        for (int i = bodyParts; i < 0; i--) {
            if(x[0] == x[i] && y[0] == y[i]){
                running = false;
            }
        }
        //checks if head collides with the wall
